...
app.post('/events', (req, res) => {
  ...
  axios.post('http://moderation-srv:4002/events', event).catch((error) => console.log(error));
  axios.post('http://query-srv:4003/events', event).catch((error) => console.log(error));
